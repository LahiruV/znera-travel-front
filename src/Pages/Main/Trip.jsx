...
const locations = [
  { name: 'Location 1', price: 100 },
  { name: 'Location 2', price: 200 },
];

const seasons = [
  { name: 'Summer', price: 150 },
  { name: 'Winter', price: 100 },
];
...
export default function Trip() {
  ...
  const calculateBudget = () => {
    ...
    const seasonPrice = seasons.find(sea => sea.name === season)?.price || 0;
    ...
    const totalCostPerPerson = noOfDays * (locationPrice + seasonPrice + accommodationPrice + transportPrice + foodPackagePrice);
